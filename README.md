...
## How to Use
The notebook (US_Champs.ipynb) walks through each chart's purpose and insights, as well as providing background information to contextualize the data.
1. Clone repository
